...
#importing libraires and corpus
import numpy as np
from nltk.corpus import brown


#understanding Brown corpus
#print(brown.sents())



#Function to return indexed_sentences,word2idx
def get_sentences_with_word2idx():
...
# function to return sentence_small,word2idx_small limit vocab
